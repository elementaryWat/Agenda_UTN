	...
	$.ajax(
				{
					...
					type:"GET",
					cache:false,
					url:"scriptsphp/obtenertutoriales.php",
					success: function(data)
					{
						$("#contenidotutoriales").html(data);
						$("#contenidotutoriales").enhanceWithin();
					}
				}
			);
}
function mostrartutorial(idtutorial)
{
	$("#tutorial"+idtutorial).slideDown();
	$("#mostrtut"+idtutorial).attr("onclick","ocultartutorial("+idtutorial+")");
}
function ocultartutorial(idtutorial)
{
	$("#tutorial"+idtutorial).slideUp();
	$("#mostrtut"+idtutorial).attr("onclick","mostrartutorial("+idtutorial+")");
}
/*----------------------------------------------------------------*/
...
<body>
      <div data-role="page" id="paginaselmaterias" data-fullscreen="true">
        ...
        <div data-role="collapsible" data-collapsed-icon="code" data-expanded-icon="code" data-collapsed="false">
           <h3>App</h3>
            <a href="#" data-role="button" data-icon="hand-o-left" onclick="obtenersug()">Sugerir</a>
             <a href="#" data-role="button" data-icon="question-circle" class="ui-btn-active">Ayuda</a>
        </div>
        ...
        <div data-role="header" data-position="fixed" data-theme="a" onclick="obteneropciones()">
         	<div class="ui-grid-b">
                    ...
                    <div class="ui-block-b" style="text-align:center"><h5>Ayuda</h5></div>
